...
| :--- | :--- | :--- | :--- |
| **Windows 10 / 11** | 🚀 **Setup Installer (.exe)** | [**Download Installer**](https://github.com/hteariH/FreeGameCompressor/releases/latest/download/FreeGameCompressor.Setup.1.2.8.exe) | Standard Windows NSIS Setup |
| **Windows 10 / 11** | 💼 **Portable (.exe)** | [**Download Portable**](https://github.com/hteariH/FreeGameCompressor/releases/latest/download/FreeGameCompressor.1.2.8.exe) | No installation needed (run anywhere) |
| **Linux (Any Distro)** | 🐧 **AppImage** | [**Download AppImage**](https://github.com/hteariH/FreeGameCompressor/releases/latest/download/FreeGameCompressor-1.2.8.AppImage) | Universal standalone Linux executable (`chmod +x`) |
| **Linux (Ubuntu / Debian)** | 📦 **Debian Package (.deb)** | [**Download .deb**](https://github.com/hteariH/FreeGameCompressor/releases/latest/download/free-game-compressor_1.2.8_amd64.deb) | Install via `sudo apt install ./file.deb` |
