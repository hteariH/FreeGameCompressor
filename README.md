...
| :--- | :--- | :--- | :--- |
| **Windows 10 / 11** | 🚀 **Setup Installer (.exe)** | [**Download Installer**](https://github.com/hteariH/FreeGameCompressor/releases/latest/download/FreeGameCompressor.Setup.1.1.10.exe) | Standard Windows NSIS Setup |
| **Windows 10 / 11** | 💼 **Portable (.exe)** | [**Download Portable**](https://github.com/hteariH/FreeGameCompressor/releases/latest/download/FreeGameCompressor.1.1.10.exe) | No installation needed (run anywhere) |
| **Linux (Any Distro)** | 🐧 **AppImage** | [**Download AppImage**](https://github.com/hteariH/FreeGameCompressor/releases/latest/download/FreeGameCompressor-1.1.10.AppImage) | Universal standalone Linux executable (`chmod +x`) |
| **Linux (Ubuntu / Debian)** | 📦 **Debian Package (.deb)** | [**Download .deb**](https://github.com/hteariH/FreeGameCompressor/releases/latest/download/free-game-compressor_1.1.10_amd64.deb) | Install via `sudo apt install ./file.deb` |
