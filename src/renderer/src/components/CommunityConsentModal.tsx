  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-surface border border-primary/40 w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="p-6 pb-4 bg-gradient-to-b from-primary/15 via-surface-elevated/40 to-surface flex flex-col items-center text-center">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-blue-600 to-cyan-400 flex items-center justify-center shadow-lg shadow-cyan-500/30 mb-3 border border-border">
        ...
        <div className="p-6 pt-2 space-y-3.5 text-xs text-slate-300">
          <div className="flex items-start gap-3 p-3 rounded-2xl bg-surface-elevated/60 border border-border">
        ...
        <div className="p-4 px-6 border-t border-border bg-surface-elevated/50 flex items-center justify-end gap-3">
          <button
            onClick={onDecline}
            className="px-4 py-2 rounded-xl bg-surface-elevated hover:bg-surface-hover text-slate-400 hover:text-slate-200 border border-border text-xs font-bold transition-all"
          >
          ...
          <button
            onClick={onAccept}
            className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-primary hover:bg-primary-hover text-white text-xs font-bold transition-all shadow-lg shadow-primary/25"
          >
